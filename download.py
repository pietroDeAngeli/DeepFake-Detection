...
# python download.py . -d original -c c23 -t videos --server EU2
# python download.py . -d Deepfakes -c c23 -t videos --server EU2


#ffmpeg -i 183.mp4 -c:v libx264 -pix_fmt yuv420p -crf 23 "converted_183.mp4"